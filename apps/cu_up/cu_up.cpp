...
int main(int argc, char** argv)
{
  ...
  app_services::executor_metrics_service_and_metrics exec_metrics_service = build_executor_metrics_service(
      metrics_notifier_forwarder, app_timers, cu_up_cfg.metrics_cfg.executors_metrics_cfg, remote_server_gateway);
  ...
  auto app_resource_usage_service = app_services::build_app_resource_usage_service(
      metrics_notifier_forwarder, cu_up_cfg.metrics_cfg.rusage_config, cu_up_logger, remote_server_gateway);
  ...
  buffer_pool_service.add_metrics_to_metrics_service(
      metrics_configs, cu_up_cfg.buffer_pool_config.metrics_config, metrics_notifier_forwarder, remote_server_gateway);
