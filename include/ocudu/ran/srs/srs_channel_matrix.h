...
public:
  ...
  {
    ocudu_assert(nof_rx_ports <= srs_constants::max_nof_rx_ports,
                 "The number of receive ports (i.e., {}) exceeds the maximum (i.e., {}).",
                 nof_rx_ports,
                 srs_constants::max_nof_rx_ports);
    ocudu_assert(nof_tx_ports <= srs_constants::max_nof_tx_ports,
  ...
  {
    ocudu_assert(get_nof_tx_ports() == other.get_nof_tx_ports(), "The number of transmit ports is not equal.");
    ocudu_assert(get_nof_rx_ports() == other.get_nof_rx_ports(), "The number of receive ports is not equal.");
