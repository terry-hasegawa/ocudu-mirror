...
public:
  ...
  create(const uplink_processor_config& config, ocudulog::basic_logger& logger, bool log_all_opportunities) = 0;
...
public:
  ...
  create(const downlink_processor_config& config, ocudulog::basic_logger& logger, bool enable_broadcast) = 0;
