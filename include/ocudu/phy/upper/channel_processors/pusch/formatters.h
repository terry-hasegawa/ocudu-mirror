...
template <>
struct formatter<ocudu::pusch_processor::codeword_description> {
  ...
  auto format(const ocudu::pusch_processor::codeword_description& codeword, FormatContext& ctx) const
  {
...
template <>
struct formatter<ocudu::pusch_processor::uci_description> {
  /// Helper used to parse formatting options and format fields.
  ocudu::delimited_formatter helper;
  ...
  template <typename FormatContext>
  auto format(const ocudu::pusch_processor::uci_description& uci_desc, FormatContext& ctx) const
  {
...
template <>
struct formatter<ocudu::pusch_processor::pdu_t> {
  /// Helper used to parse formatting options and format fields.
  ocudu::delimited_formatter helper;
  ...
  auto format(const ocudu::pusch_processor::pdu_t& pdu, FormatContext& ctx) const
  {
    ...
    helper.format_if_verbose(ctx, "ports={}", ocudu::span<const uint8_t>(pdu.rx_ports));
...
template <>
struct formatter<ocudu::pusch_decoder_result> {
  /// Helper used to parse formatting options and format fields.
  ocudu::delimited_formatter helper;
  ...
  template <typename FormatContext>
  auto format(const ocudu::pusch_decoder_result& result, FormatContext& ctx) const
  {
...
template <>
struct formatter<ocudu::pusch_processor_result_data> {
  /// Helper used to parse formatting options and format fields.
  ocudu::delimited_formatter helper;
  ...
  template <typename FormatContext>
  auto format(const ocudu::pusch_processor_result_data& result, FormatContext& ctx) const
  {
...
template <>
struct formatter<ocudu::pusch_processor_result_control> {
  /// Helper used to parse formatting options and format fields.
  ocudu::delimited_formatter helper;
  ...
  template <typename FormatContext>
  auto format(const ocudu::pusch_processor_result_control& result, FormatContext& ctx) const
  {
