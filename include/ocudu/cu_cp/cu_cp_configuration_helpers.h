...
///                   timers for details.
inline std::map<five_qi_t, ocucp::cu_cp_qos_config> make_default_cu_cp_qos_config_list()
{
  std::map<five_qi_t, ocucp::cu_cp_qos_config> qos_list = {};
  //
...
inline ocucp::cu_cp_configuration make_default_cu_cp_config()
{
  ocucp::cu_cp_configuration cfg{};
  // DRBs
...
inline bool is_valid_configuration(const ocucp::cu_cp_configuration& config)
{
...
inline std::vector<plmn_identity> get_supported_plmns(const std::vector<ocucp::cu_cp_configuration::ngap_config>& ngaps)
{
